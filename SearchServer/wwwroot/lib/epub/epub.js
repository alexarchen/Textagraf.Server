...
var Contents = function () {
   ...
   */
		...
		value: function size(width, height) {
			...
			if (width >= 0) {
				this.width(width);
				viewport.width = width;              // ZAKH was 12
				 this.css("padding", "0 " + width / 40 + "px", true);
			}
   ...
   */
		...
		value: function update(_offset) {
			...
			for (var i = 0; i < viewsLength; i++) {
				...
				isVisible = true;//ZAKH this.isVisible(view, offset, offset, container);
		...
		value: function check(_offsetLeft, _offsetTop) {
			...
			var contentLength = 0;//ZAKH horizontal ? this.container.scrollWidth : this.container.scrollHeight;
  ...
  */
   ...
   */
		...
		value: function calculate(_width, _height, _gap) {
			...
			var section = Math.floor(width / 20); // ZAKH 12
